"""
This file contains code for creating and saving visualization
...
def save_overlay_plot(original_img, registered_img, save_dir, frame_idx=3):
    """
...
def plot_intensity_origin(all_masks, 
                          unwrap_params_stack,
                          unwrap_imgs_stack,
    ...
    for ii, (unwrap_params, unwrap_img) in enumerate(zip(unwrap_params_stack, unwrap_imgs_stack)):
        ...
        for jj, mask in enumerate(masks[s:e]):
